...
interface CustomStaticImageData {
  src: string; // Path to the image
  width: number; // Image width
  height: number; // Image height
  // Add any other properties that might be needed, based on how you use the images
}
      ...
      <div>
        <div className="relative flex justify-center mb-8" data-aos="zoom-y-out" data-aos-delay="450">
          <div className="flex flex-col justify-center">
            ...
            <img className="bg-gradient-to-r from-blue-500 to-teal-500 shadow-xl bg-gray-900" src={thumb} width={thumbWidth} height={thumbHeight} alt={thumbAlt} />
