...
import Example from "./img/innovationstudios.png";
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-slate-200">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="sm:text-4xl text-3xl font-bold font-alliance text-slate-800">
              Our Services
            </h2>
          </div>
          ...
          <div className="max-w-xl mx-auto md:max-w-none flex flex-col md:flex-row md:items-start md:space-x-8 lg:space-x-16 xl:space-x-18 space-y-8 space-y-reverse md:space-y-0">
            ...
            <div className="md:w-7/12 lg:w-1/2" data-aos="fade-up">
              <div className="mb-8 text-center md:text-left">
                <h3 className="h3 text-slate-800 font-alliance mb-3"></h3>
                <p className="text-xl font-alliance text-slate-500">
              ...
              <div className="mb-8 md:mb-0">
                <button
                  className={`flex items-start text-left bg-white border-2 px-5 py-3 rounded shadow-md transition duration-300 ease-in-out mb-3 ${
                    tab !== 1
                      ...
                      : "border-2 border-teal-200 opacity-100"
                  }`}
                  onClick={(e) => {
                    e.preventDefault();
                    setTab(1);
                ...
                >
                  ...
                  <div>
                    <div className="text-slate-800 font-medium font-alliance mb-1">
                      Website development
                    </div>
                    <div className="text-slate-300 font-alliance">
                      Duis aute irure dolor in reprehenderit in voluptate velit
                      esse cillum dolore eu fugiat nulla pariatur velit.
                    </div>
                  </div>
                </button>
                <button
                  className={`flex items-start text-left bg-white border-2 px-5 py-3 rounded shadow-md transition duration-300 ease-in-out mb-3 ${
                    tab !== 2
                      ? "border-transparent opacity-50 hover:opacity-75"
                      : "border-2 border-teal-400 opacity-100"
                  }`}
                  onClick={(e) => {
                    e.preventDefault();
                    setTab(2);
                ...
                >
                  ...
                  <div>
                    <div className="text-slate-800 font-alliance font-medium mb-1">
                      Software Development
                    </div>
                    <div className="text-slate-500 font-alliance">
                      Duis aute irure dolor in reprehenderit in voluptate velit
                      esse cillum dolore eu fugiat nulla pariatur velit.
                    </div>
                  </div>
