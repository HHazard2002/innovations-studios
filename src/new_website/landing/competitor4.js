    ...
    <section className="relative bg-zinc-50  pb-20 md:pb-40">
      <div className="py-0 md:py-0">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <p className="text-center text-sm mt-10 max-w-lg mx-auto font-alliance text-slate-900"></p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              <button
                className={`text-left px-4 py-5 border border-transparent rounded ${
                  tab !== 2
                    ...
                    : "[background:linear-gradient(theme(colors.white),theme(colors.white))_padding-box,linear-gradient(120deg,theme(colors.teal.300),theme(colors.teal.100),theme(colors.teal.300))_border-box] shadow-sm rotate-1"
                }`}
                onClick={(e) => {
                  e.preventDefault();
                  setTab(2);
              ...
              >
                <div className="flex items-center justify-between mb-1">
                  <div className="font-inter-tight font-bold text-slate-900 font-alliance">
                    1. Usual outsourcing
                  </div>
                  <svg
                ...
                <div className="text-sm text-slate-900 font-alliance">
